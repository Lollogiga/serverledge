#!/bin/bash
# Batch-profile tutte le varianti PiLeibniz e aggiorna automaticamente il JSON.
# Uso: ./ProfilePiLeibniz.sh
...
/usr/bin/python3 ../profile_variants.py \
  --batch-json ../../variants/PiLeibniz/PiLeibniz.json \
  --function-prefix piLeibniz \
  --n-warmup 3 \
  --n-samples 50 \
  --wait-after 90 \
  --poll-interval 5 \
